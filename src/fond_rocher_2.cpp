...
const int rocher2_animation[] = {57, 58, 58, 59, 59, 59, 60, 60, 60, 60, 60, 59, 59, 59, 58, 58,
								 57, 61, 61, 62, 62, 62, 63, 63, 63, 63, 63, 62, 62, 62, 61, 61};
...
void FondRocher2::update() {
	...
	for (int i = x - 45; i < x + pic->xSize() - 45; i++) y_plat[4][i] = y - 25;
