...
const int monolite_animation[] = {50, 51, 51, 52, 52, 52, 53, 53, 53, 53, 53, 52, 52, 52, 51, 51,
								  50, 54, 54, 55, 55, 55, 56, 56, 56, 56, 56, 55, 55, 55, 54, 54};
...
void FondRocher1::update() {
	...
	for (int i = x - 45; i < x + pic->xSize() - 45; i++) y_plat[4][i] = y - 30;
